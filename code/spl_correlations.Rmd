...
#splAvg = read.csv("data/clean_data/avg_pmHT_spl.csv")
...
# load species specific catch data and filter to species of interest
std_catch = read.csv("data/clean_data/std_catch_sum.csv")
ecometrics$silverPerch = std_catch$num_bai_chr
ecometrics$pigfish = std_catch$num_ort_chr
