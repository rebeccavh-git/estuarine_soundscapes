...
metricCorrComplete = cor(ecometrics_num, use = "complete.obs", method = "pearson")
metricCorrEverything = cor(ecometrics_num, use = "everything", method = "pearson")
metricCorrSpearman = cor(ecometrics_num, method = "spearman")

# save both methods and compare output
write.csv(metricCorrComplete, "data/clean_data/metricCorrComplete.csv")
write.csv(metricCorrEverything, "data/clean_data/metricCorrEverything.csv")

ecometrics_Complete = ecometrics_num %>%
  select(halodule, oyster, saltmarsh, total_cover, depth_m_avg, sal_avg, comm_evenness_sum, omnivore,
         num_bai_chr, num_ort_chr, seagrass_area, oyster_core.area, oyster_perim.area.ratio, habitat_total, 
         dist2adjPatch, richness_landscape, avg_temp, avg_spl_low, avg_spl_high, BI_low, BI_high)

ecometrics_Everything = ecometrics_num %>%
  select()
...
```{r}
# ecometrics_1 = ecometrics[,c(5:24,27:36,38:65,71:107)]
...
# 
# # HABITAT
# # possibly need to remove oyster due to correlation with oyster area (landscape)
