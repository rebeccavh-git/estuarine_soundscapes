...
ecometrics = left_join(ecometrics, BI, by = "site_code")
...
## Identify correlated ecometrics and save filtered ecometrics dataframe
- this is ecometrics with all habitats included
