...
This is old code from before ecometrics included ALL metrics (hab,comm,land,nn)

- Need to finalize removing correlated ecometric variables then inlcude all candidate ecometrics in the nmds plot
...
# 
# # Went through the correlation matrix and identified correlated variables to remove.
# env_filt = env_data %>%
#   select(halodule, zostera, ruppia, algae, oyster, saltmarsh, other, richness, evenness, seagrass_area, seagrass_perim.area.ratio,
#          seagrass_shape.index, saltmarsh_area, saltmarsh_perim.area.ratio, nn_Land, richness_land)
# 
